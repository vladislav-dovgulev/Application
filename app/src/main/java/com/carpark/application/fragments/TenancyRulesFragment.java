...
/**
 * Фрагмент, реализующий отображение правил аренды.
 */
public class TenancyRulesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tenancy_rules, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) this.getView().findViewById(R.id.tenancy_rules_text);
        Cursor cursor = database.GetQuery("SELECT * FROM params");
        try {
            if (cursor.moveToFirst()) {
                textView.setText(cursor.getString(cursor.getColumnIndex("tenancy_rules")));
            }
        } finally {
            cursor.close();
        }
